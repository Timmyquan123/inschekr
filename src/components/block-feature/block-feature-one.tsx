					...
					<div className="row">
						<div className="col-md-6">
							<div className="title-one text-center text-md-start mb-30 sm-mb-10">
								<h2>Explore our insurance tools.</h2>
							</div>
						</div>
					</div>
            ...
            {service_items.map((item,i) => (
                  ...
                  <Image src={arrow} alt="arrow" className="lazy-img"/>
					...
					<div className="section-subheading sm-mt-40">
						<p className="text-lg">InSchekr brings simple, reliable tools to decode vehicles, estimate values, calculate premiums, and compare policies—so you can choose confidently.</p>
						<Link href="/service-v2" className="btn-three icon-link">
